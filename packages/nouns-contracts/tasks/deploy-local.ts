...
task('deploy-local', 'Deploy contracts to hardhat')
  ...
  .addOptionalParam('auctionDuration', 'The auction duration (seconds)', 60 * 8, types.int) // Default: 4 minutes
  .addOptionalParam('minDuration', 'The auction MINIMUM duration (seconds)', 60 * 60 * 24 * 30, types.int) // Default: 4 minutes
  .addOptionalParam('maxDuration', 'The auction MAXIMUM duration (seconds)', 60 * 1, types.int) // Default: 4 minutes
